...
function showtime() {
	...
	if(document.getElementById("close-left")!=null){
		document.getElementById("close-left").onclick=function(){
			advcloseleft();
		}
	}
	if(document.getElementById("close-right")!=null){
		document.getElementById("close-right").onclick=function(){
			advcloseright();
		}
	}
